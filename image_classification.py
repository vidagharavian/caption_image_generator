...
for categories in os.listdir(train_path):
    ...
    for i in range(rows * cols):
        ...
        image_id = os.listdir(path)[np.random.randint(0, 10)]
...
class_names = ['aeroplane', 'bicycle', 'bird', 'boat', 'bus', 'car', 'cat', 'chair', 'cow', 'diningtable', 'dog', 'horse', 'motorbike', 'person', 'pottedplant', 'sheep', 'sofa', 'train', 'tvmonitor']
